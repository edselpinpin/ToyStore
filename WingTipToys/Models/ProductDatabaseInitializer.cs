...
DropCreateDatabaseAlways<ProductContext>
    {
        ...
        private static List<Product> GetProducts()
        {
             ...
             new Product
                ...
                Description = "This convertible car is fast! The engine is  powered by a neutrino based battery (not included)." + "Power it up and let it go!",                 ImagePath="carconvert.png",
                UnitPrice = 22.50,
                CategoryID = 1
            },
             new Product
